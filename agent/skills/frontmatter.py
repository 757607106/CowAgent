...
def parse_metadata(frontmatter: Dict[str, Any]) -> Optional[SkillMetadata]:
    ...
    # Unwrap nested namespace (e.g. {"openclaw": {...}} or {"coreagent": {...}})
...
_KNOWN_METADATA_NAMESPACES = {"coreagent", "openclaw"}


def _unwrap_metadata_namespace(metadata_raw: Dict[str, Any]) -> Dict[str, Any]:
    """
    Unwrap a single-key namespace wrapper like {"coreagent": {...} or {"openclaw": {...}}}.
