...
class Agent:
    def __init__(self, system_prompt: str, description: str = "AI Agent", model: LLMModel = None,
                 ...
                 runtime_info: dict = None, custom_system_prompt: str = "",
        ...
        :param custom_system_prompt: Explicit agent-level system prompt configured by user
        :param knowledge_enabled: Agent-level knowledge switch. None means fallback to global config.
        """
    ...
    def run_stream(self, user_message: str, on_event=None, clear_history: bool = False, skill_filter=None, cancel_token=None) -> str:
        """
