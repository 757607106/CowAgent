---
title: 功能介绍
description: CoreAgent 长期记忆、个人知识库、任务规划、技能系统、CLI 命令、浏览器工具详细说明
---
...
- **[Skill Hub](https://skills.coreagent.ai/)：** 开放的技能广场，汇集官方推荐、社区贡献和第三方技能，支持一键安装。
...
访问 [skills.coreagent.ai](https://skills.coreagent.ai/) 浏览所有可用技能，或在对话中执行：
...
CoreAgent 提供两种命令交互方式，覆盖服务管理、技能安装、配置调整等日常运维操作：
...
详细命令参考 [命令总览](https://docs.coreagent.ai/cli)。
