---
title: 项目架构
description: CoreAgent 2.0 的系统架构和核心设计
---

CoreAgent 2.0 从简单的聊天机器人全面升级为超级智能助理，采用 Agent 架构设计，具备自主思考、规划任务、长期记忆和技能扩展等能力。

## 系统架构

CoreAgent 的整体架构由以下核心模块组成：
...
启用 Agent 模式后，CoreAgent 会以自主智能体的方式运行，核心工作流如下：
