...
```json
{
  "channel_type": "web",
  "web_port": 9899,
  "platform_database_url": "postgresql://cowplatform:cowplatform@127.0.0.1:55432/cowplatform"
}
```
...
| `platform_database_url` | PostgreSQL DSN for tenants, agents, sessions, memory indexes, jobs, and audit logs | `postgresql://cowplatform:cowplatform@127.0.0.1:55432/cowplatform` |
