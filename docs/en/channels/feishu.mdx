---
title: Feishu (Lark)
description: Integrate CoreAgent into Feishu application
---

Integrate CoreAgent into Feishu by creating a custom enterprise app. You need to be a Feishu enterprise user with admin privileges.
