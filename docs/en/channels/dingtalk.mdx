---
title: DingTalk
description: Integrate CoreAgent into DingTalk application
---

Integrate CoreAgent into DingTalk by creating an intelligent robot app on the DingTalk Open Platform.
