---
title: WeCom
description: Integrate CoreAgent into WeCom enterprise app
---

Integrate CoreAgent into WeCom through a custom enterprise app, supporting one-on-one chat for internal employees.
