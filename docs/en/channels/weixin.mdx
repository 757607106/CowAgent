---
title: WeChat
description: Connect CoreAgent to personal WeChat
---

> Connect CoreAgent to your personal WeChat. Simply scan a QR code to log in — no public IP required. Supports text, image, voice, file, and video messages.
