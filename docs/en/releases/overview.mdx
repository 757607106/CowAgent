---
title: Changelog
description: CoreAgent version history
---

| Version | Date | Description |
| --- | --- | --- |
| [2.0.7](/en/releases/v2.0.7) | 2026.04.22 | Image Generation Skill, new model support, knowledge base enhancements, Web Console improvements and bug fixes |
...
See [GitHub Releases](https://github.com/zhayujie/CoreAgent/releases) for full history.
