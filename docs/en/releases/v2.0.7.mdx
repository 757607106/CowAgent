---
title: v2.0.7
description: CoreAgent 2.0.7 - Image Generation Skill (6-provider auto-routing), new models, knowledge base enhancements, Web Console improvements and bug fixes
---
...
Docs: [Image Generation Skill](https://docs.coreagent.ai/en/skills/image-generation)
...
**Release Date**: 2026.04.22 | [Full Changelog](https://github.com/zhayujie/CoreAgent/compare/2.0.6...master)
