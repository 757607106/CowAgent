...
description: Deploy CoreAgent manually (source code / Docker)
---
...
<Tip>
  For network issues, use the mirror: https://gitee.com/zhayujie/CoreAgent
</Tip>
...
<Tip>
  Full configuration options are in the project [`config.py`](https://github.com/zhayujie/CoreAgent/blob/master/config.py).
</Tip>
