...
description: CoreAgent command system — Terminal CLI and chat commands
---

CoreAgent provides two ways to interact via commands:
...
Service:
  start     Start the CoreAgent service
  stop      Stop the CoreAgent service
  restart   Restart the CoreAgent service
