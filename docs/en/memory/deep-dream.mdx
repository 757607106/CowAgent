...
Deep Dream is the core consolidation mechanism of CoreAgent's memory system, responsible for distilling scattered daily memories into refined long-term memory and generating dream diaries.

## Memory Flow

CoreAgent's memory progresses through three stages from short-term to long-term:
