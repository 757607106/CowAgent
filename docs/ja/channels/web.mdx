...
| `platform_database_url` | tenant、Agent、session、memory index、job、audit log 用の PostgreSQL DSN | `postgresql://cowplatform:cowplatform@127.0.0.1:55432/cowplatform` |
