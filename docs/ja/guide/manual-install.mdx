---
title: 手動インストール
description: CoreAgentの手動デプロイ（ソースコード / Docker）
---
...
<Tip>
  ネットワークに問題がある場合は、ミラーを使用してください: https://gitee.com/zhayujie/CoreAgent
</Tip>
...
<Tip>
  すべての設定オプションはプロジェクトの [`config.py`](https://github.com/zhayujie/CoreAgent/blob/master/config.py) に記載されています。
</Tip>
